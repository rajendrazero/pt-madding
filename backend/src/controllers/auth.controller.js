    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                return [4 /*yield*/, (0, auth_service_1.registerUser)(email, password)];
            case 1:
                user = _b.sent();
                res.status(201).json({ message: 'Pendaftaran berhasil', user: user });
                return [3 /*break*/, 3];
            case 2:
                err_1 = _b.sent();
...
var login = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                result = _b.sent();
                res.json(__assign({ message: 'Login berhasil' }, result));
                return [3 /*break*/, 3];
            case 2:
                err_2 = _b.sent();
