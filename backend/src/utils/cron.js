    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, (0, auth_service_1.cleanUnverified)()];
            case 2:
                _a.sent();
            ...
            case 3:
                error_1 = _a.sent();
                console.error('> Gagal menjalankan cleanUnverified:', error_1);
                return [3 /*break*/, 4];
            case 4:
                _a.trys.push([4, 6, , 7]);
                console.log('> Menjalankan deleteOldSoftDeletedUsers...');
                return [4 /*yield*/, (0, user_service_1.deleteOldSoftDeletedUsers)()];
            case 5:
                _a.sent();
            ...
            case 6:
                error_2 = _a.sent();
                console.error('> Gagal menjalankan deleteOldSoftDeletedUsers:', error_2);
                return [3 /*break*/, 7];
